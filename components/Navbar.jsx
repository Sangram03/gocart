                ...
                <div className="flex items-center justify-between max-w-7xl mx-auto py-4">
                    ...
                    <div className="hidden sm:flex items-center gap-4 lg:gap-8 text-slate-600">
                        ...
                        <Link href="/cart" className="relative flex items-center gap-2">
                            ...
                            Cart
                            <span className="absolute -top-1 left-3 text-[8px] text-white bg-slate-600 w-4 h-4 flex items-center justify-center rounded-full">
                                {cartCount}
                            </span>
                        </Link>
                    ...
                    <div className="sm:hidden flex items-center gap-3">
                        ...
                        <Link href="/cart" className="relative">
                            ...
                            <span className="absolute -top-1 -right-2 text-[8px] text-white bg-slate-600 w-4 h-4 flex items-center justify-center rounded-full">
                                {cartCount}
                            </span>
                        </Link>
                        ...
                        {user ? (
                            ...
                            <SignInButton mode="modal">
                                <button className="px-4 py-1.5 bg-indigo-500 text-white text-sm rounded-full">
                                    Login
                                </button>
                            </SignInButton>
                        )}
